...
from PyQt5.QtCore import QUrl,QTimer,QCoreApplication, pyqtSignal, QObject
import webbrowser
...
class YerKontrolIstasyonu(QMainWindow):
    ...
    def __init__(self):
     ...
     # Başlangıçta verileri yükle
        ...
        self.map_center = (40.99560207079153, 29.062867334869093)  # Varsayılan merkez
    ...
    def on_button_dusman_goster_clicked(self):
        try:
            ...
            # Haritayı yeniden oluştur ve düşmanları göster
            self.harita_guncelle()
