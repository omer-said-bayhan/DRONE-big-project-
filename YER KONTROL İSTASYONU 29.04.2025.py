...
class YerKontrolIstasyonu(QMainWindow):
    def __init__(self):
       ...
       #bağlan butonu
        ...
        """self.button_yndnbslt = QPushButton("YENİDEN BAŞLAT", self.gorev_kontrol_tab)
        self.button_yndnbslt.setFixedSize(250, 100)
        self.button_yndnbslt.move(1400, 12)
        self.button_yndnbslt.setStyleSheet("""""""
        ...
        #self.dusman_coord_input.setStyleSheet("background-color: rgb(140, 102, 223); border: 2px solid black;")
        ...
        #self.button_dusman_goster.setStyleSheet("background-color: rgb(109, 80, 171); border: 2px solid black;")
     ...
     # Başlangıçta verileri yükle
        ...
        self.zoom_level = 20 # Varsayılan zoom
    ...
    def ciz_kare(self):
        ...
        self.zigzag_rota = rota  # Daha sonra çizmek için sakla
        self.harita_guncelle()
