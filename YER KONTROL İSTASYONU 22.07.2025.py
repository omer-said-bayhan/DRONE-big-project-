...
import os
from PyQt5.QtWidgets import QApplication, QMainWindow,QFileDialog, QWidget, QLabel,QMessageBox, QTabWidget, QPushButton, QFrame, QVBoxLayout, QLineEdit, QHBoxLayout,QTextEdit
...
class YerKontrolIstasyonu(QMainWindow):
    ...
    def __init__(self):
       ...
       #bağlan butonu
        ...
        self.map_center = ( -35.36321719 ,149.16516857)  #   40.99525748424568, 29.064774246937173              -35.36321719 ,149.16516857
        ...
        self.webView_g.setFixedSize(1050, 950)
    ...
    def on_button_baglan_clicked(self):
        try:
            self.vehicle = connect(ipdrone ,wait_ready=True, baud=57600)
